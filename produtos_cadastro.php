...
<body>
    ...
    <h2><img src="img\producticon.png" alt="producticon" style="height: 28px; widght: 28px; margin-right: 8px;">Cadastro de Produtos</h2>
    <form method="POST" action="">
        ...
        <input class="form-control" type="number" id="valorunitario" name="valorunitario" required step="0.01" value="><br><?php echo $ProductToEdit['valorunitario'] ?? ''; ?>"><br>
    ...
    <?php foreach ($Products as $Product): ?>
        <tr>
            ...
            <td>
                ...
                <a href="detalhes_produto.php?id=<?php echo $Product['id']; ?>" class="btn btn-secondary btn-sm">Ver Detalhes</a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
